              ...
              children: [
                Container(
                  ...
                  child: PageView(
                    ...
                    onPageChanged: (index) {
                      providerController.changeIndexPageViewHotelScreen(index);
                    },
                    children: [
                      ...List.generate(
                        DataList.dataHotels.length,
                        (index) {
                          return WidgetsGlobal.category_Information_Card(
                              context: context, index: index,data: DataList.dataHotels,type:"hotel");
                        },
                      ),
                    ],
                  ),
                ...
                PositionedDirectional(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...List.generate(DataList.dataHotels.length, (index) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...List.generate(DataList.dataHotels[providerController.indexPageViewHotelScreen].propertiesList.length, (index){
                            return WidgetsGlobal.customText(
                                context: context,
                                text:
                                "${DataList.dataHotels[providerController.indexPageViewHotelScreen].propertiesList[index]}",
                                fontSize: 14,
                                fontcolor:
                  ...
                  WidgetsGlobal.customText(
                      context: context,
                      text:
                          "${DataList.dataHotels[providerController.indexPageViewHotelScreen].desc}",
                      fontSize: 14,
                    ...
                    children: [
                      ...List.generate(3, (index) {
                        return Container(
                            ...
                            child: Image.asset(
                              DataList.imagesPathHotelScreen[index],
                              width: 100,
                              height: 100,
                              fit: BoxFit.cover,
                            ));
